...
function CustomerSelect({ value, onChange }) {
    ...
    const [customers, setCustomers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "CustomerSelect.useState": ()=>{
            // Load saved customers from localStorage (only in browser)
    ...
    const handleSelect = (currentValue)=>{
        ...
        if (currentValue.trim()) {
            addNewCustomer(currentValue.trim());
        }
    };
    const handleInputChange = (search)=>{
        onChange(search);
        if (search.trim() && !customers.includes(search.trim())) {
            addNewCustomer(search.trim());
        }
    };
...
_s(CustomerSelect, "2q0ybhx18ecw+Q3hH/Cs8IBduSg=");
_c = CustomerSelect;
var _c;
...
_s(CarOrderPage, "pYTMJsiSq9G5LOb1KJjmsVaZXd4=");
_c = CarOrderPage;
var _c;
...
//# sourceMappingURL=src_a419c703._.js.map